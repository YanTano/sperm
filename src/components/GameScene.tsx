...
function EggCells() {
  ...
  return (
    <group>
      ...
      <instancedMesh ref={coronaMeshRef} args={[null as any, null as any, 1000]} frustumCulled={false}>
      ...
      <instancedMesh ref={coreMeshRef} args={[null as any, null as any, 1000]} castShadow receiveShadow frustumCulled={false}>
